...
const Header = () => {
  // useSelector ile reducer daki statlere eriş
    ...
    <header className="shadow">
      <div className="max-w-[1440px] mx-auto p-5 lg:p-8 flex items-center justify-between">
        ...
        <div className="flex gap-5">
          ...
          >
            <span>Yakınınızda {restaurants?.length || 0} </span>
            <IoRestaurant className="text-red-500" />
            <span className="max-md:hidden"> Restaurant Var </span>
          </Link>

          <button
            className=" border py-1 px-3 text-red-500  hover:bg-red-400 hover:text-white
          transition cursor-pointer max-md:hidden"
          >
            Giriş Yap
          </button>
          <button
